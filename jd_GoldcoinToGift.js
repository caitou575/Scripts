...
!(async () => {
  ...
  // let res = await getAuthorShareCode('https://raw.githubusercontent.com/1Aaron-lv/updateTeam/master/shareCodes/GoldcoinToGift.json')
  // if (!res) {
  //   $.http.get({url: 'https://purge.jsdelivr.net/gh/1Aaron-lv/updateTeam@master/shareCodes/GoldcoinToGift.json'}).then((resp) => {}).catch((e) => console.log('刷新CDN异常', e));
  //   await $.wait(1000)
  //   res = await getAuthorShareCode('https://cdn.jsdelivr.net/gh/1Aaron-lv/updateTeam@master/shareCodes/GoldcoinToGift.json')
  // }
