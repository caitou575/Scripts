...
//下面给出好友邀请助力的示例填写规则
let invite_pins = ['jd_6f1f1368ca855,jd_46d70bca92313'];
//下面给出好友赛跑助力的示例填写规则
let run_pins = ['jd_6f1f1368ca855,jd_46d70bca92313'];
//friendsArr内置太多会导致IOS端部分软件重启,可PR过来(此处目的:帮别人助力可得30g狗粮)
let friendsArr = ["jd_6f1f1368ca855", "jd_46d70bca92313"]
    ...
    if (cookiesArr[i]) {
      ...
      if ($.isNode()) {
        if (process.env.JOY_RUN_HELP_MYSELF) {
          ...
          let fixPins = run_pins.splice(run_pins.indexOf('jd_6f1f1368ca855'), 1);
