...
[task_local]
#取关京东店铺商品
25 0-23/3 * * * jd_unsubscribe.js, tag=取关京东店铺商品, img-url=https://raw.githubusercontent.com/Orz-3/mini/master/Color/jd.png, enabled=true
===========Loon============
[Script]
cron "25 0-23/3 * * *" script-path=jd_unsubscribe.js,tag=取关京东店铺商品
============Surge=============
取关京东店铺商品 = type=cron,cronexp="25 0-23/3 * * *",wake-system=1,timeout=3600,script-path=jd_unsubscribe.js
===========小火箭========
取关京东店铺商品 = type=cron,script-path=jd_unsubscribe.js, cronexpr="25 0-23/3 * * *", timeout=3600, enable=true
 */
