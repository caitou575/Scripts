...
[task_local]
#京东极速版
21 1,8 * * * https://raw.githubusercontent.com/Aaron-lv/sync/jd_scripts/jd_speed_sign.js, tag=京东极速版, img-url=https://raw.githubusercontent.com/Orz-3/task/master/jd.png, enabled=true

================Loon==============
[Script]
cron "21 1,8 * * *" script-path=https://raw.githubusercontent.com/Aaron-lv/sync/jd_scripts/jd_speed_sign.js,tag=京东极速版

===============Surge=================
京东极速版 = type=cron,cronexp="21 1,8 * * *",wake-system=1,timeout=33600,script-path=https://raw.githubusercontent.com/Aaron-lv/sync/jd_scripts/jd_speed_sign.js

============小火箭=========
京东极速版 = type=cron,script-path=https://raw.githubusercontent.com/Aaron-lv/sync/jd_scripts/jd_speed_sign.js, cronexpr="21 1,8 * * *", timeout=33600, enable=true
*/
...
function invite2() {
  let t = +new Date()
  let inviterId = [
    "TqX7VpttIBtdfziyK1TZmjVLyOauY1Pis2hcE76qLkA="
...
function invite() {
  let t = +new Date()
  let inviterId = [
    "TqX7VpttIBtdfziyK1TZmjVLyOauY1Pis2hcE76qLkA%253D"
  ][Math.floor((Math.random() * 1))]
  var headers = {
    'Host': 'api.m.jd.com',
    'accept': 'application/json, text/plain, */*',
