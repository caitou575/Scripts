...
!(async () => {
    ...
    let res = [];
    // try{res = await getAuthorShareCode('https://raw.githubusercontent.com/l6/share_code/main/qjd.json');}catch (e) {}
    // if(!res){
    //     try{res = await getAuthorShareCode('https://gitee.com/st7/share-code/raw/master/qjd.json');}catch (e) {}
    //     if(!res){res = [];}
    // }
    // if(res.length > 0){
    //     let len = 3;
