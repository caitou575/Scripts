...
[task_local]
#京喜领88元红包
4 0,20 * * * https://raw.githubusercontent.com/Aaron-lv/sync/jd_scripts/jd_jxlhb.js, tag=京喜领88元红包, img-url=https://raw.githubusercontent.com/Orz-3/mini/master/Color/jd.png, enabled=true

==============Loon==============
[Script]
cron "4 0,20 * * *" script-path=https://raw.githubusercontent.com/Aaron-lv/sync/jd_scripts/jd_jxlhb.js,tag=京喜领88元红包

================Surge===============
京喜领88元红包 = type=cron,cronexp="4 0,20 * * *",wake-system=1,timeout=3600,script-path=https://raw.githubusercontent.com/Aaron-lv/sync/jd_scripts/jd_jxlhb.js

===============小火箭==========
京喜领88元红包 = type=cron,script-path=https://raw.githubusercontent.com/Aaron-lv/sync/jd_scripts/jd_jxlhb.js, cronexpr="4 0,20 * * *", timeout=3600, enable=true
 */
...
!(async () => {
  ...
  console.log('京喜领88元红包\n' +
      ...
      '助力逻辑：先自己京东账号相互助力，如有剩余助力机会，则助力作者\n' +
      '温馨提示：如提示助力火爆，可尝试寻找京东客服')
  // let res = await getAuthorShareCode('https://raw.githubusercontent.com/1Aaron-lv/updateTeam/master/shareCodes/jxhb.json')
  // if (!res) {
  //   $.http.get({url: 'https://purge.jsdelivr.net/gh/1Aaron-lv/updateTeam@master/shareCodes/jxhb.json'}).then((resp) => {}).catch((e) => $.log('刷新CDN异常', e));
  //   await $.wait(1000)
  //   res = await getAuthorShareCode('https://cdn.jsdelivr.net/gh/1Aaron-lv/updateTeam@master/shareCodes/jxhb.json')
  // }
