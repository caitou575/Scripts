...
function readShareCode() {
  return new Promise(async resolve => {
    $.get({url: `https://raw.githubusercontent.com/caitou575/sharecodes/main/jd_plantbean.json`, 'timeout': 10000}, (err, resp, data) => {
      try {
        if (err) {
...
function shareCodesFormat() {
  return new Promise(async resolve => {
    ...
    newShareCodes = ["olmijoxgmjutyvrbqgrni34j5kbxxzek4kjunxa","e7lhibzb3zek3ieehju757u4aj2r5hkkns2ai7i","olmijoxgmjuty6mch7645m4zrniqy72jiaukydq","7oivz2mjbmnx5fstv5zjlrxqnkyv3z2bbxsm6py"];
    ...
    if (readShareCodeRes) {
      ...
      rdmsharecodes = await getRandomArrayElements(readShareCodeRes.data,Math.ceil(cookiesArr.length/3) + 4);//随机抽n个取助力码
