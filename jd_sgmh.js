...
function shareCodesFormat() {
  return new Promise(async resolve => {
    ...
    $.newShareCodes = [ "T0225KkcRkgYo1XUJhKnxf8PcQCjVQmoaT5kRrbA","T0225KkcRBhN8lSFc0v9lvQLdwCjVQmoaT5kRrbA","T0225KkcRhcZplPeIRinkaQPIgCjVQmoaT5kRrbA","T0205KkcG0JBhyWdRHun6ZRxCjVQmoaT5kRrbA"];
    ...
    if (readShareCodeRes) {
      ...
      rdmsharecodes = await getRandomArrayElements(readShareCodeRes.data,Math.ceil(cookiesArr.length/2) + 4);//随机抽n个取助力码
...
function readShareCode() {
  ...
  return new Promise(async resolve => {
    $.get({
      url: `https://raw.githubusercontent.com/caitou575/sharecodes/main/jd_sgmh.json`,
      'timeout': 10000
    }, (err, resp, data) => {
      try {
        if (err) {
