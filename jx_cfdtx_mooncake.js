...
async function cfd() {
  try {
    ...
    //  console.log(`兑换成功获得：10元！`)
    //} else {
    //  console.log(`没抢到！${cashOutRes.sErrMsg}`)
    //}
...
/*
dwLvl=7&dwIsRandHb=0&ddwVirHb=20&strPoolName=anhjZmQyX2V4Y2hhbmdlX2hjaGJfMjAyMTEwMjM%3D&dwExchangeType=0
4  500
3  1000
*/
function cashOut() {
  return new Promise((resolve) => {
    $.get(taskUrl(`user/ExchangePearlHb`, `dwLvl=4&dwIsRandHb=0&ddwVirHb=500&strPoolName=anhjZmQyX2V4Y2hhbmdlX2hjaGJfMjAyMTEwMjM%3D&dwExchangeType=0`), (err, resp, data) => {
      try {
        if (err) {
          console.log(`${JSON.stringify(err)}`)
...
/*
/jxbfd/user/ExchangePearlHb?__t=1635229142708&strZone=jxbfd&dwLvl=7&dwIsRandHb=0&ddwVirHb=20&strPoolName=anhjZmQyX2V4Y2hhbmdlX2hjaGJfMjAyMTEwMjM%3D&dwExchangeType=0&_stk=__t%2CddwVirHb%2CdwExchangeType%2CdwIsRandHb%2CdwLvl%2CstrPoolName%2CstrZone&_ste=1&h5st=20211026141902709%3B9546090113182163%3B10032%3Btk01w71f11ad830njE9Tq4Gjbq7dMSsYQEimRGrH74Qx%2F1k22gk0BzGsOD38J2F2ZxeKD84XVj83MIPKodUqBPt4Jgyt%3Baa0b723e44d9d87b54a74e0bdb7a080818e8631c8cd0161c009c438bec99428f&_=1635229142716&sceneval=2&g_login_type=1&callback=jsonpCBKI&g_ty=ls HTTP/1.1
*/
function taskUrl(function_path, body = '') {
  let url = `${JD_API_HOST}jxbfd/${function_path}?__t=1635229142708&strZone=jxbfd&${body}&_stk=__t%2CddwVirHb%2CdwExchangeType%2CdwIsRandHb%2CdwLvl%2CstrPoolName%2CstrZone&_ste=1`;
  url += `&h5st=${decrypt(Date.now(), '', '', url)}&_=${Date.now() + 2}&sceneval=2&g_login_type=1&callback=jsonpCBKI&g_ty=ls`;
  return {
    url,
    headers: {
      Cookie: cookie,
...
/*
/jxbfd/user/ExchangePearlState?__t=1635229143471&strZone=jxbfd&dwExchangeType=undefined&_stk=__t%2CstrZone&_ste=1&h5st=20211026141903472%3B9546090113182163%3B10032%3Btk01w71f11ad830njE9Tq4Gjbq7dMSsYQEimRGrH74Qx%2F1k22gk0BzGsOD38J2F2ZxeKD84XVj83MIPKodUqBPt4Jgyt%3Bcd836583fb8694f1162ec99774ce6345b865c933f950a4ed66f5ca6dfc6c9612&_=1635229143478&sceneval=2&g_login_type=1&callback=jsonpCBKJ&g_ty=ls HTTP/1.1
*/
function taskUrl1(function_path) {
  let url = `${JD_API_HOST}jxbfd/${function_path}?__t=1635229143471&strZone=jxbfd&dwExchangeType=undefined&_stk=__t%2CstrZone&_ste=1`;
  url += `&h5st=${decrypt(Date.now(), '', '', url)}&_=${Date.now() + 2}&sceneval=2&g_login_type=1&callback=jsonpCBKJ&g_ty=ls`;
  return {
    url,
    headers: {
      Cookie: cookie,
